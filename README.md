...
Если вам интерестно версии до 2.4.0 существуют первой стабильной стала 1.7.1
более старые версии вызывали проблемы с производительностью они не вылажены в сеть можете не искать
...
Для работы визуализаций желательно использовать VB-Cable или Virtual Audio Cable
