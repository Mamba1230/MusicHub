...
- **Базовые:** Полоски, Волна, Круг, Огонь, Частицы, Спектр
- **Премиум:** 3D Туннель, 3D Куб, Галактика, Северное сияние, Лава, Неон, Вихрь, Цветок, Фрактал, Пульс, Эквалайзер, Лазер, Глитч, Плазма
...
- Клик по URL — редактирование адреса
...
### Антивирус может ругаться на media_watcher.exe

Это ложное срабатывание. Программа только:
- Получает информацию о текущем треке из Windows
- Сохраняет обложку и название в папку %APPDATA%\musichub
- Никаких вирусов нет

Добавьте файл в исключения антивируса или отключите временно.
